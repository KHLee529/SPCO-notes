...
set label 1 "mu" at 1.50000, 0.0332530, 0.00000 left norotate back nopoint
set label 2 "sigma" at 3.00000, 0.161314, 0.00000 left norotate back nopoint
set arrow 1 from 1.00000, 0.00000, 0.00000 to 1.00000, 0.265962, 0.00000 nohead back nofilled linewidth 1.000 dashtype solid
set arrow 2 from 1.00000, 0.161314, 0.00000 to 2.50000, 0.161314, 0.00000 nohead back nofilled linewidth 1.000 dashtype solid
set samples 200, 200
set style data lines
set ytics  norangelimit 0.00000,0.033253,0.332530
set title "normal PDF using logistic approximation" 
set xlabel "x ->" 
set xrange [ -5.00000 : 7.00000 ] noreverse nowriteback
set x2range [ * : * ] noreverse writeback
set ylabel "probability density ->" 
set yrange [ 0.00000 : 0.332530 ] noreverse nowriteback
